$(document).ready(function() {
    ...
    $.ajax({
            type: "POST",
            url: "http://192.168.1.73/ArchivosServidor/mostrarAlimentos.php",
            cache: false,
            beforeSend: function() {
...
function detalleAlim(id){
    ...
    $.ajax({
      type: "POST",
      url: "http://192.168.1.73/ArchivosServidor/detalleAlimento.php",
      cache: false,
      data: "id="+id,
      beforeSend: function() {
  ...
  $("#miPlanAlimenticio").on("pageshow", function(){ 
    $.ajax({
      type: "POST",
      url: "http://192.168.1.73/ArchivosServidor/agregarAlimento.php",
      cache: false,
      beforeSend: function() {
