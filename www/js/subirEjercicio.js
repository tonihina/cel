 $(document).ready(function() {
                    $.ajax({
                            type: "POST",
                            url: "http://192.168.1.73/ArchivosServidor/selectEjercicio.php",
                    ...
                    $.ajax({
                        type: "POST",
                        url: "http://192.168.1.73/ArchivosServidor/selectMusculo.php",
                        success: function(response)
                        {
                ...
                $.ajax({
                    type: "POST",
                    url: "http://192.168.1.73/ArchivosServidor/selectFuncion.php",
                    success: function(response)
                    {
