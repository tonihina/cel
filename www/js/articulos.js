...
$(document).ready(function() {
    ...
    $.ajax({
            type: "POST",
            url: "http://192.168.1.73/ArchivosServidor/mostrarArticulos.php",
            cache: false,
            beforeSend: function() {
...
$(function(){
  $("#insertarArticulo").on("click", function(){
      ...
      var ruta = "http://192.168.1.73/ArchivosServidor/subirArticulo.php";
      $.ajax({
          url: ruta,
          type: "POST",
          data: formData,
...
function verArticulo(articulo){
    ...
    $.ajax({
        type: "POST",
        url: "http://192.168.1.73/ArchivosServidor/contenidoArticulo.php",
        cache: false,
        data: "id="+articulo,
        beforeSend: function() {
